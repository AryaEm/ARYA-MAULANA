...
export const projects: Project[] = [
  ...
  },
  {
    ...
    num: 'PROJECT_05',
    title: 'DiveLight',
    tagline: 'A visual-first Ive gallery, built to explore how far aesthetic and layout can carry user experience.',
    tags: ['Next.js', 'Tailwind', 'Firebase', 'Cloudinary'],
    role: 'Design + Dev',
    impact: 'Visual-focused exploration',
    impactColor: 'pink',
    liveUrl: 'https://divelight.vercel.app/',
    previewUrl: '/preview/divelight.png',
    icon: 'ti-image',
    blocks: [
      {
        num: '01 / problem',
        title: 'Most gallery websites feel generic.',
        body: 'Image galleries are often treated as simple grids with no identity. They show content, but don’t create an experience. For visual heavy content, especially fan-based media, presentation matters as much as the content itself.',
      },
      {
        num: '02 / solution',
        title: 'Design the experience, not just the grid.',
        body: 'Built a clean, immersive gallery that prioritizes visual hierarchy and browsing flow. The layout is intentionally minimal to let the content stand out, while still feeling curated and not template-like.',
      },
      {
        num: '03 / technical',
        title: 'Performance meets aesthetic.',
        body: 'Focused on optimizing image heavy UI while maintaining smooth navigation. Structured components for reuse and scalability, ensuring the gallery can grow without breaking layout or performance.',
      },
    ],
  },
  {
